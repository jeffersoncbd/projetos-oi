...
if [[ "$response" != *"\"type\":\"success\""* ]]; then
    /webaplic/.bin/tg -845994286 "✅ GED360 [QRCode] retornou sucesso."
else
    /webaplic/.bin/tg -845994286 "⚠️ ATENÇÃO ⚠️"
    /webaplic/.bin/tg -845994286 "O GED 360 retornou algo diferente de type=sucesso"
    /webaplic/.bin/tg -845994286 "Resposta do endpoint: ${response}"
fi
